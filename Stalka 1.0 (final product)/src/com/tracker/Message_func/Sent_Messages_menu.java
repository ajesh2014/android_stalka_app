...
public class Sent_Messages_menu  extends ListActivity {
   	 ...
   	 ///////////////////////////////////////////////////
   	    ...
   	    runnable = new Runnable() {
 	    		...
 	    		dbHelperUser.open();
    	    		...
    	    		Log.i("test",phoneid);
    	    		dbHelperUser.close();
   	    		  listarray = servconn.getSentMessages(phoneid);
  ...
  handler.postDelayed(this, 5000);
    ...
    protected void onListItemClick(ListView listView, View view, int position, long id) {
	 ...
	 Intent i = new Intent(activity, View_message.class);
		i.putExtra(" recipeien_id ",data.getString("from_id") );
		startActivity(i);
		 finish();
		 startActivity(i);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        case 2 :
			...
			if(servconn.DeleteMessages(data.getString("from_id"), data.getString("to_id"))){
				 ...
				 Intent i = new Intent(activity, Sent_Messages_menu.class);
					//i.putExtra("sender_id",data.getString("from_id") );
							 startActivity(i);
							  finish();
							 startActivity(i);
